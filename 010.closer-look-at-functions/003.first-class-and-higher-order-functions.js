/*
    ...
    We can store functions in variables, attach them as object properties, pass them as arguments to other functions.
    ...
    So a higher order function is either a function that receives another function as an argument, or a function that
    ...
    First class functions is a feature that a programming language can or cannot possess. All it means is that all
    functions are values. That's it. There are no first class functions in practice. It is just a concept.
