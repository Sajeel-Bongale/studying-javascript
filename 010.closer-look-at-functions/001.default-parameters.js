...
createBooking('LH123', 2); // sets price to  2 * 199
createBooking('LH123', 5); // sets price to  5 * 199

// Example 2
createBooking('LH123', undefined, 1000); // to skip the second param so that it sets to default