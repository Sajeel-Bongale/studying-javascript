/*
    Link: https://www.udemy.com/course/the-complete-javascript-course/learn/lecture/22648673#overview
    ...
    3. Create a method 'displayResults' which displays the poll results. The method takes a string as an
        input (called 'type'), which can be either 'string' or 'array'. If type is 'array',
...
poll.registerNewAnswer = function () {
    ...
    if (choice && choice >= 0 && choice <= 3) {
        poll.answers[choice]++;
        this.displayResults();
        this.displayResults('string'); // Solution 4
    }
