/*
    ...
    Inside the runtime are 3 main components (at least when it comes to browser runtimes)

    1. The Call stack and Heap (Makes up the engine)
    The call stack holds the current Execution Context(EC) placed on top of one another with the most recent
    EC being placed at the top of the stack. The heap is used for storing objects and acts as the
